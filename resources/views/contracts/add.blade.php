                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <textarea class="form-control" name="content" id="content"
                                                placeholder="Kontrak Karyawan" cols="10">
                                                    ...
                                                    <p style="text-align:justify"><span style="font-size:12pt"><span style="text-justify:inter-ideograph"><span new="" roman="" style="font-family:" times=""><span style="font-size:11.0pt">2.&nbsp;&nbsp;&nbsp;&nbsp; Nama &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <b id="employee_name">HANA ROSDIANA</b></span></span></span></span></p>
